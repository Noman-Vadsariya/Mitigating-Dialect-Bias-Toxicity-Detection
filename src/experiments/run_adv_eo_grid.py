...
from train_adv_xgb import load_split, sigmoid, tune_thresholds, apply_thresholds              
...
def main():
    ...
    p.add_argument("--out_dir", default="data/results/adv_xgb_eo_grid")
    ...
    print(f"Config: EO adversary on margin, projection={not args.no_projection}, "
