...
# Already done in hatexplain.py, so we skip this step here
...
#     df_balanced,
#     test_size=0.3,
#     stratify=df_balanced[["label", "dialect_strict"]],
#     random_state=SEED
# )
...
#     temp,
#     test_size=0.5,
#     stratify=temp[["label", "dialect_strict"]],
#     random_state=SEED
# )
...
# 8. SAVE FILES
# =========================
# We need to entire dataset as test to be used for generating AAE and SAE test sets for the bias evaluation
df_balanced.to_csv("../../data/processed/hatexplain/test.csv", index=False)
# val.to_csv("../../data/processed/hatexplain/val.csv", index=False)
# test.to_csv("../../data/processed/hatexplain/test.csv", index=False)
...
check_distribution(df_balanced, "TRAIN")
